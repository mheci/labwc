...
impl FRect {
    ...
    /// Round to an integer rectangle, saturating at i32 bounds.
    #[inline]
    #[must_use]
    pub fn round(&self) -> Rect {
        ...
        Rect::new(
            saturate(self.x.round()),
            saturate(self.y.round()),
            saturate(self.width.round().max(0.0)),
            saturate(self.height.round().max(0.0)),
        )
    }
}
